...
export default function ChatPanel({ messages, onSendMessage, currentUser, socket, roomId }) {
      ...
      <form onSubmit={handleSubmit} className="p-4 border-t-2 border-gray-300">
        <div className="flex gap-2 items-center">
          <input
            ...
            className="flex-1 px-3 py-2 border-2 border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
          />
          <VideoCall socket={socket} roomId={roomId} currentUser={currentUser} />
          <button
            type="submit"
